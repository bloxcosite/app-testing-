function loadapp() {
    ...
    action="https://docs.google.com/forms/d/e/1FAIpQLSf6qoIJB7h5Ei6SV3l9mN3ycq1Bo6VlIARK34nEFWfqjq3ufA/formResponse" method="post" target="sucessMessage" onsubmit="submitted = true">
    ...
    <div id="q-exp">
      ...
      <label class="fw-bold">Do you have any past experience in the field of HR?<span
          class="required">*</span></label><br />
      <input type="radio" name="entry.867206986" id="yesexp" value="Yes" class="form-check-input" required>
      <label for="yesexp">Yes, I have past HR experience.</label><br>
      <input type="radio" name="entry.867206986" id="no" value="No" class="form-check-input">
      <label for="no">No, I do not have any past HR experience.</label><br>
      <hr />
    </div>
    <!-- Question exp -->
    ...
    <div id="q-pastworkprovide" class="mt-3">
      <label for="pastworkprovide" class="fw-bold">Provide a link to your <a title="Past work" href="#q-pastworkprovide">portfolio</a>.
    ...
    <div id="q-whatrankisuserquestion" class="mt-3" style="display: none;">
      ...
      <datalist id="l1">
        ...
        <!-- stops at rd due to general manager being hr -->
      </datalist>
    </div>
    <!-- Question wrank (not shown if not staff) -->
    ...
    <!-- 
      https://docs.google.com/forms/d/e/1FAIpQLSf6qoIJB7h5Ei6SV3l9mN3ycq1Bo6VlIARK34nEFWfqjq3ufA/viewform?usp=pp_url
      &entry.1558978144=--MEETREQS--
      &entry.1297779522=--DISCORD--
      &entry.676113539=--ROBLOX--

      &entry.1637324133=--WHYGREATADDITION--
      &entry.1702676137=--WHYJOIN--
      &entry.1462851399=--STRENGthS--
      &entry.925928335=--WEAK--

      &entry.132675210=--ARESTAFF--
      &entry.1258969994=--ARESTAFFRANK--

      &entry.1293895348=--COMMENTS--

      &entry.867206986=--EXPERIENCE--
      &entry.1565504565=--PORTFOLIO--
      &entry.531372543=--CAN WE FIRE YOU--
      &entry.1614805812=-auto
      -->
